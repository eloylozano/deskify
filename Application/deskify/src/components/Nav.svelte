...
<nav class="flex h-screen w-fit flex-col bg-[#02353C] p-5 text-white">
	...
	<div class="mx-auto mt-10 flex h-full flex-col justify-between">
		...
		<li>
		  ...
		  <a href="/dashboard" aria-label="dashboard page">
			<svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 24 24">
			  <path fill="currentColor" d="M21 21H3v-2h18zM8 10H4v7h4zm6-4h-4v11h4zm6-3h-4v14h4z"></path>
			</svg>
		  </a>
		</li>
		<li>
		  ...
		  <a href="/tickets" aria-label="tickets page">
			<svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 24 24">
			  <path fill="currentColor" d="M5 6a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h7.17a3.001 3.001 0 0 1 5.66 0H19a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1.17a3.001 3.001 0 0 1-5.66 0zM2 7a3 3 0 0 1 3-3h8a1 1 0 0 1 1 1a1 1 0 1 0 2 0a1 1 0 0 1 1-1h2a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-2a1 1 0 0 1-1-1a1 1 0 1 0-2 0a1 1 0 0 1-1 1H5a3 3 0 0 1-3-3zm13 2a1 1 0 0 1 1 1v.5a1 1 0 1 1-2 0V10a1 1 0 0 1 1-1m1 4.5a1 1 0 1 0-2 0v.5a1 1 0 1 0 2 0z"></path>
			</svg>
		  </a>
		</li>
		<li>
	  ...
	  <a href="/user" aria-label="user page">
		<svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 24 24">
		  <path fill="currentColor" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4zM12 2c3.31 0 6 2.69 6 6s-2.69 6-6 6s-6-2.69-6-6s2.69-6 6-6zM12 22c2.67 0 5-2.33 5-5h-2c0 1.66-1.34 3-3 3s-3-1.34-3-3h-2c0 2.67 2.33 5 5 5z"></path>
		</svg>
	  </a>
	</div>
  </nav>
